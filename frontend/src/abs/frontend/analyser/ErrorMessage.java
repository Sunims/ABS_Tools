...
public enum ErrorMessage {
    ...
    EXPECTED_PHYSICAL_TYPE("Expected numeric type for physical block, but found type %s instead."),
    ...
    DIFFERENTIAL_NOT_ALLOWED("DifferentialExp is not allowed in this context"),
